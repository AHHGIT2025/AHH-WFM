...
import { acknowledgeOperationalAlert } from "@/lib/secfac-alert-service";
...
export async function POST(
  ...
  const auth = await checkApiAuth(undefined, {
    ...
    requiredPermission: "secfac.alerts.acknowledge"
  });
  ...
  try {
    ...
    const updated = await acknowledgeOperationalAlert(params.id, userId, body.note);
