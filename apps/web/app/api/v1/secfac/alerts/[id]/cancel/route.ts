...
import { cancelOperationalAlert } from "@/lib/secfac-alert-service";
...
export async function POST(
  ...
  try {
    ...
    const updated = await cancelOperationalAlert(params.id, userId, body.reason || body.cancellationReason);
