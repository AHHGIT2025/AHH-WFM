  ...
  return (
    <div className="flex-1 bg-[#F9F9FF] p-8 font-['IBM_Plex_Sans',_sans-serif] min-h-[85vh]">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8 border-b border-[#E7EEFF] pb-6">
        <div>
          <div className="flex items-center gap-3 mb-2">
            ...
            <h1 className="text-2xl font-bold text-[#001A48] tracking-tight">Audit Trail</h1>
          ...
          <p className="text-sm text-[#444651] max-w-xl">
            Trace dispatcher dashboard overrides, checklist template modifications, and security tour updates.
          </p>
        </div>
      </div>
      ...
      <div className="bg-white border border-[#C4C6D2] rounded-lg p-12 text-center mb-8 shadow-sm">
        <span className="material-[#002D72] material-symbols-outlined text-4xl mb-4">page_info</span>
        <h3 className="text-base font-bold text-[#001A48] mb-1">No Audit Logs</h3>
        <p className="text-xs text-[#747782] max-w-sm mx-auto mb-6">
          Dispatcher session actions, override notes, and manual checklist status overrides will log here.
        </p>
      ...
      <div className="bg-white border border-[#C4C6D2] rounded-lg p-6 shadow-sm">
        ...
        <ul className="grid grid-cols-1 md:grid-cols-2 gap-4 text-xs text-[#444651] list-inside list-disc">
          <li><strong>Dispatcher Action Logs:</strong> Tracks every dashboard button action and override trigger.</li>
          <li><strong>Template Versions:</strong> Log changes to dynamic checklist questions.</li>
          <li><strong>Tag Binding Logs:</strong> Traces register activity for physical check hardware.</li>
        </ul>
      </div>
    </div>
  );
