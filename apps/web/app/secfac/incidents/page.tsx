    ...
    <SecfacPageGuard>
      <div className="flex-1 bg-[#F9F9FF] p-8 font-['IBM_Plex_Sans',_sans-serif] min-h-[85vh]">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8 border-b border-[#E7EEFF] pb-6">
          <div>
            ...
            <p className="text-sm text-[#444651] max-w-xl">
              Dispatcher console to view safety hazards, security breaches, maintenance issues, and camera snapshot evidence.
            </p>
          </div>
        </div>
        ...
        <div className="bg-white border border-[#C4C6D2] rounded-lg p-12 text-center mb-8 shadow-sm">
          <span className="material-[#002D72] material-symbols-outlined text-4xl mb-4">gavel</span>
          <h3 className="text-base font-bold text-[#001A48] mb-1">No Active Incidents</h3>
          <p className="text-xs text-[#747782] max-w-sm mx-auto mb-6">
            Incident reports and photo evidence attachments filed by mobile workers will show here.
          </p>
          <button disabled className="px-4 py-2 bg-[#002D72]/50 text-white text-xs font-bold rounded cursor-not-allowed">
            Open Review Desk (Phase 1B)
          </button>
        </div>
        ...
        <div className="bg-white border border-[#C4C6D2] rounded-lg p-6 shadow-sm">
          ...
          <ul className="grid grid-cols-1 md:grid-cols-2 gap-4 text-xs text-[#444651] list-inside list-disc">
            <li><strong>Photo Verification:</strong> Image carousel displaying officer-submitted snaps.</li>
            <li><strong>Safety Escalation:</strong> Assign incident follow-up orders to specific engineers.</li>
            <li><strong>Audit Logs:</strong> Tracks incident status shifts and dispatcher comments.</li>
          </ul>
        </div>
      </div>
    </SecfacPageGuard>
