...
export default function DashboardPage() {
  ...
  useEffect(() => {
    fetchSummary();
    const interval = setInterval(() => fetchSummary(false), 15000);
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 bg-surface-container-low p-4 rounded-xl border border-border-subtle">
        ...
        <div className="flex flex-wrap items-center gap-2 w-full sm:w-auto">
          ...
          >
            <option value="all">Al Hattab Holding (All)</option>
            <option value="ahg">AHG Contracting</option>
            <option value="sec">Al Hattab Security</option>
            <option value="fm">Al Hattab Facility Mgt</option>
          </select>
      ...
      <section className="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <Card className="p-4 flex flex-col gap-3">
          ...
          <ul className="space-y-2 text-[11px] font-medium text-on-surface">
            ...
            <li className="flex justify-between">
              <span className="text-on-surface-variant">Approved Today</span>
        ...
        <Card className="p-4 flex flex-col gap-3">
          ...
          <ul className="space-y-2 text-[11px] font-medium text-on-surface">
            <li className="flex justify-between">
              <span className="text-on-surface-variant">Active Shifts Today</span>
            ...
            <li className="flex justify-between">
              <span className="text-on-surface-variant">Relievers Assigned</span>
      ...
      <Card className="overflow-hidden relative p-0 min-h-[400px] flex flex-col border border-border-subtle">
          ...
          {data.regionalActivity.length === 0 ? (
            ...
            data.regionalActivity.map((reg, idx) => {
              ...
              return (
                ...
                >
                  <div className="w-4 h-4 rounded-full bg-status-success shadow-[0_0_12px_#1E8E3E] animate-pulse border-2 border-white flex items-center justify-center text-[8px] font-extrabold text-white">
                    {reg.count}
                  </div>
                  <div className="absolute top-5 z-20 bg-slate-900 text-white text-[10px] p-2 rounded shadow-xl whitespace-nowrap flex flex-col border border-slate-700 pointer-events-none opacity-0 group-hover/pin:opacity-100 transition-opacity">
