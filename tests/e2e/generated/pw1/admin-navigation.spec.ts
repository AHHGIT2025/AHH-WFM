// spec: specs/playwright/pw1-agent-admin-navigation.md
// seed: tests/e2e/seed.spec.ts
// generator: playwright_test_generator
...
test.describe('ADMIN Navigation & Layout Verification (Agent Generated)', () => {
...
test.describe('Authentication Lifecycle (Agent Generated)', () => {
...
test.describe('Role-Based Access Control (RBAC) & Restricted Role Navigation (Agent Generated)', () => {
