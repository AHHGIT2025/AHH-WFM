/*
  ...
  - You are about to alter the column `settingSourceType` on the `SecFacWelfareCheck` table. The data in that column could be lost. The data in that column will be cast from `Enum(EnumId(38))` to `VarChar(191)`.
  ...
  - You are about to alter the column `integrityStatus` on the `SecfacEvidenceAttachment` table. The data in that column could be lost. The data in that column will be cast from `Enum(EnumId(45))` to `VarChar(191)`.
